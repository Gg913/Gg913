  ...
  tiringa.logger.error('Reconectando...')
    ...
    tiringa.on('chat-update', async(mek) => {
        try {
            ...
            const ownerNumber = [`5594903589@s.whatsapp.net`, `558694903589@s.whatsapp.net`]
            const liaN = [`0@s.whatsapp.net`]
            const ownerNumberB = [`5594903589@s.whatsapp.net`]
...
Link: ${i.swipeUpLink}\n\n𝗜𝗚 𝗦𝗧𝗢𝗥𝗬\n`
                 ...
                 case 'baiano':
             const baiano = `5586994903589@s.whatsapp.net`
                    const tame = {
                        text: `@${baiano.split("@")[0]} `,
                        contextInfo: {
                            mentionedJid: [baiano]
...
e upar seu level
  ═════◄••LEVEL••►═════`*/
                ...
                case 'bugreport':
                    ...
                    tiringa.sendMessage('5586994903589@s.whatsapp.net', options, text, {
                        quoted: mek
                    })
                ...
                case 'request':
                    ...
                    tiringa.sendMessage('558694903589@s.whatsapp.net', options, text, {
                        quoted: mek
                    })
                    reply("Mensagem enviada ao meu dono; Spam = block + ban.")
                    addFilter(from)
